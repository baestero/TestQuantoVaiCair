...
import {
  ...
  salarioComVtSIM,
  salarioComVtNAO,
  salarioComDescontosAddeVtSIM,
  salarioComDescontosAddeVtNAO,
  salarioComDescontosLimpoVtSIM,
  salarioComDescontosLimpoVtNAO,
  validarSalarioLiquido,
...
context("Quanto vai cair (tablet)", () => {
  ...
  it("verifica o titulo da aplicação", verificaTitulo);
  it("calcular com valor estipulado em 0", calculaValorEm0);
  it("calcular com valor limpo", calculaValorLimpo);
  it(
    "preencher salario, sem selecionar preferencia por vale  transporte",
    salarioSemVT
  );
  it("preencher salario e vale transporte: SIM", salarioComVtSIM);
  it("preencher salario e vale transporte: NAO", salarioComVtNAO);
  it(
    'preencher salario, descontos adicionais e vale transporte: "SIM" ',
    salarioComDescontosAddeVtSIM
  );
  it(
    'preencher salario, descontos adicionais e vale transporte: "NAO" ',
    salarioComDescontosAddeVtNAO
  );
  it(
    'preencher salario, descontos adicionais (valor limpo)  e vale transporte: "SIM" ',
    salarioComDescontosLimpoVtSIM
  );
  it(
    'preencher salario, descontos adicionais (valor limpo)  e vale transporte: "NAO" ',
    salarioComDescontosLimpoVtNAO
  );
  it("Validar Salario Liquido", validarSalarioLiquido);
});
